This is a readme for the 0x00-hello_world directory. the directory contains: 0-preprocessor: an executable shell script that runs a C file through the preprocessor and save the result into another file.
